...
NotebookDataLength[     25895,        483]
NotebookOptionsPosition[     25555,        459]
NotebookOutlinePosition[     26497,        489]
CellTagsIndexPosition[     26423,        484]
WindowFrame->Normal*)
...
Cell[BoxData[
 RowBox[{"Get", "@", 
  RowBox[{
  "URLDownload", "[", 
   "\"\<https://raw.githubusercontent.com/wqfang/HCMP_Project/master/src/GUI2.\
wl\>\"", "]"}]}]], "Input",
 ...
 CellLabel->
  "In[188]:=",ExpressionUUID->"8841a066-2333-45df-a981-fcca830a398c"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`NoBeads$$ = 1, $CellContext`NoConfgs$$ = 
    3, $CellContext`WorkDir$$ = 
    "/Users/wenqiangfang/Dropbox \
(Brown)/Research/HCP_Forces/GitRepo/HCMP_Project/ExampleData/", 
...
$CellContext`EEDensityList, $CellContext`EEList]; 
 ...
 CellChangeTimes->{
  3.800788000039022*^9, {3.815754055468072*^9, 3.815754076475233*^9}},
 CellTags->"Subroutines",
 CellLabel->
  "Out[188]=",ExpressionUUID->"8a73341c-a46a-4a9c-8ce5-23399230bf69"],
...
\\!\\(\\*RowBox[{\\\"\\\\\\\"Work Dir: \\\\\\\"\\\", \\\"<>\\\", \
\\\"$Canceled\\\"}]\\).\"", 2, 189, 4, 33129176414495128085, "Local"},
  "MessageTemplate"]], "Message", "MSG",
 CellChangeTimes->{3.815754099606105*^9},
 CellTags->"Subroutines",
 CellLabel->"",ExpressionUUID->"4fd8c4ad-3d5d-4b60-bde5-0c0b3f2995ca"]
}, Open  ]]
},
...
ExpressionUUID->"b1709a6d-46ba-4805-8dd6-f34b287dd899"
]
...
CellTagsIndex->{
 "Subroutines"->{
  Cell[1486, 35, 6663, 98, 19, "Input",ExpressionUUID->"8841a066-2333-45df-a981-fcca830a398c",
   CellOpen->False,
   InitializationCell->True,
   CellTags->"Subroutines"],
  Cell[8152, 135, 16940, 310, 508, "Output",ExpressionUUID->"8a73341c-a46a-4a9c-8ce5-23399230bf69",
   CellTags->"Subroutines"],
  Cell[25095, 447, 444, 9, 24, "Message",ExpressionUUID->"4fd8c4ad-3d5d-4b60-bde5-0c0b3f2995ca",
   CellTags->"Subroutines"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"Subroutines", 25971, 472}
 }
*)
(*NotebookFileOutline
Notebook[{
...
(* NotebookSignature 1XOquHou4bVq3VNfu8m1j1zq *)
